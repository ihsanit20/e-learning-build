import{x as c,y as i,z as e,P as V,r as R,I as q,a2 as D,A as _,D as E,X as B,C as l,B as a,U as j,a9 as z,F as U,G as H}from"./vue-CcEtAIOs.js";import{u as I}from"./quiz-CYZ7dmxu.js";import{h as O}from"./vendor-PJuFQbji.js";import"./index-Dxm2rnF7.js";const Q={__name:"QuizResultImageDownload",props:["page"],setup(f){const t=f,r=I(),y=d=>d?d.slice(0,3)+"*****"+d.slice(-3):"",n=async()=>{var h,x;const d=r.results.data||r.results,g=((h=r==null?void 0:r.quiz)==null?void 0:h.title)||"result",p=document.createElement("div");p.classList.add("max-w-max","pb-2"),p.innerHTML=`
