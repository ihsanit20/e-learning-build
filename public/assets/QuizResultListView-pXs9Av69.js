import{d as c,i,e,b as V,r as R,o as I,w as D,p as m,B as E,q as B,t as l,g as a,z as j,A as q,F as H,f as O}from"./index-BeNg25hN.js";import{u as z}from"./quiz-suEpO5I3.js";import{h as Q}from"./html2canvas.esm-DyqYn1B1.js";const U={__name:"QuizResultImageDownload",props:["page"],setup(f){const t=f,r=z(),h=d=>d?d.slice(0,3)+"*****"+d.slice(-3):"",n=async()=>{var y,x;const d=r.results.data||r.results,g=((y=r==null?void 0:r.quiz)==null?void 0:y.title)||"result",p=document.createElement("div");p.classList.add("max-w-max","pb-2"),p.innerHTML=`
